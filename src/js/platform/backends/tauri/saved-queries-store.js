/**
 * Tauri Saved Queries Store Backend
 *
 * This module handles the persistence of saved SQL queries in the Tauri environment.
 * Queries are stored in a JSON file located at `AppData/joinery/saved_queries/saved_queries.json`.
 */

import { readJsonFile, writeJsonFile } from './tauri-fs-utils.js';

const QUERIES_PATH = ['joinery', 'saved_queries', 'saved_queries.json'];
...
async function readStorage() {
    const data = await readJsonFile(...QUERIES_PATH);
...
async function writeStorage(data) {
    return writeJsonFile(data, ...QUERIES_PATH);
}
